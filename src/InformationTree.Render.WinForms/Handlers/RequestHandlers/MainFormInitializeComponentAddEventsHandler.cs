...
public class MainFormInitializeComponentAddEventsHandler
    : IRequestHandler<MainFormInitializeComponentAddEventsRequest, BaseResponse>
{
    public Task<BaseResponse> Handle(MainFormInitializeComponentAddEventsRequest request, CancellationToken cancellationToken)
    {
